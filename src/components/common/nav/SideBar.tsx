...
export default function SideBar() {
  ...
  return (
    <aside className="hidden md:flex w-64 h-full bg-gray-600 text-white flex-col p-4 transition-transform duration-300 md:translate-x-0 -translate-x-full z-10">
      ...
      <div className="mt-auto flex items-center space-x-2 p-2 hover:bg-gray-700 rounded-lg">
        <LogoutButton />
      </div>
    </aside>
  );
